...
csv_file_list = [r"C:\Users\gangliagurdian\Desktop\Files for combining\filesforcaedon11.19\8_19_24_Cleaned\Complex_1hr_1\gh_timestamps_2024-08-19T10_38_48.csv",
                 r"C:\Users\gangliagurdian\Desktop\Files for combining\filesforcaedon11.19\8_19_24_Cleaned\Complex_1hr_2\gh_timestamps_2024-08-19T11_56_56.csv",
                 r"C:\Users\gangliagurdian\Desktop\Files for combining\filesforcaedon11.19\8_19_24_Cleaned\Complex_1hr_3\gh_timestamps_2024-08-19T13_11_52.csv",
                 r"C:\Users\gangliagurdian\Desktop\Files for combining\filesforcaedon11.19\8_19_24_Cleaned\Complex_1hr_4\gh_timestamps_2024-08-19T14_24_15.csv",
                 r"C:\Users\gangliagurdian\Desktop\Files for combining\filesforcaedon11.19\8_19_24_Cleaned\Complex_30min_5\gh_timestamps_2024-08-19T15_37_27.csv"]

# Input the path to where you want to store the result
output_file = r"c:\Users\gangliagurdian\Desktop\Files for combining\filesforcaedon11.19\8_19_24_Cleaned\Complex_Results.csv"
...
for i in range(len(csv_file_list)):
    if first_file:
        ...
        final_row = df_name.iloc[-1].astype('int64')  # Stores the final row of the first file
        subtraction = final_row - df_name.iloc[-2].astype('int64')  # Divides the last two rows
        ...
        w = 0
        while w < row_count:
            sum_row = (temp2 + subtraction).astype('int64')  # Add final row + the subtacted rows
